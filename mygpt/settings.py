...
LLM_HF_MODEL_NAME = os.getenv("LLM_HF_MODEL_NAME")
LLM_HF_MODEL_FILE = os.getenv("LLM_HF_MODEL_FILE")
...
SECRET_KEY = 'django-insecure-b=l34x!)dvk3q!0%$$zj4bf#(qr_umc1%!k&q=&r0et241z&**'
